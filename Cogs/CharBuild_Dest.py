...
class CharBuild(commands.Cog):
    ...
    async def b(self, ctx, cmd: str= None):
        if cmd is None:
            embed = discord.Embed(colour=discord.Colour(0xDC143C),
...
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
        ...
        if cmd == 'raven':
            embed = discord.Embed(colour=discord.Colour(0x800080),
                                  description="""⚡ **[Damage Dealer - G70]**""")
            embed.add_field(name="⚙ STATS", value="""```Attack       6000
Health       27000 
Defense      35 
CAD          300 
CAC          75
...
CAC resist   0```""")
            ...
            embed.add_field(name="⚙ GEARS", value="""```8 ATTACK, 4 FAC, 2 CAC, 1 CAD```""")
...
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
        ...
        if cmd == 'mando':
            embed = discord.Embed(colour=discord.Colour(0x800080),
                                  description="""⚡ **[Lethal Damage Dealer - G70]**""")
...
DOT resist   ???
CAC resist   ???```""")
            embed.add_field(name="⚙ TALENTS", value="""```5 LAC```""")
            embed.add_field(name="⚙ GEARS", value="""```15 ATTACK```""")
            embed.add_field(name="💎 FACTS", value="""```Best Raid Master.```
            
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
            embed.set_footer(
                text=f"Requested by: {ctx.message.author.name} at {ctx.message.guild.name}",icon_url=ctx.guild.icon_url)
            embed.set_image(url="https://tenor.com/bpEmY.gif")
...
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
            ...
            embed.set_thumbnail(
                url="https://pbs.twimg.com/media/E8rjrVsXIAEdZVy?format=jpg&name=4096x4096")
            await ctx.channel.send(embed=embed)
        #Silvers
        if cmd == 'aww':
...
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
            ...
            embed.set_thumbnail(url="https://www.dccomics.com/sites/default/files/field/image/LevelingUpWW84_blog_5fe3f5adb2b7e3.11496492.jpg")
            await ctx.channel.send(embed=embed)
...
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
        ...
        if cmd == 'vxn':
            embed = discord.Embed(colour=discord.Colour(0xFFD700),
                                  description="""⚡**[Damage Dealer - G70]**""")
            embed.add_field(name="⚙STATS", value="""```Attack       5200
Health       26060
Defense      70 
CAD          270 
CAC          75
...
__**Note**__: If you have any ideas, suggestions or you faced a problem, you can join the support server by clicking this link: [S. T. A. R. LABS Support](https://discord.gg/S7MvBVh4Hy).""")
            ...
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/attachments/816978583142137908/876768028933632050/image0.jpg")
            await ctx.channel.send(embed=embed)
